...
class data_base:
    ...
    def insert_langue(self, item):
        self.cur.execute("""INSERT OR IGNORE INTO H_langue (langue) VALUES(?)""", item)
    ...
    def instert_description(self, item):
        self.cur.execute("""INSERT OR IGNORE INTO D_description (id_competence, id_langue, description) VALUES(?,?,?)""", item)
    ...
    def insert_location(self, item):
        self.cur.execute("""INSERT OR IGNORE INTO D_location (id_departement, ville) VALUES(?,?)""", item)
    ...
    def insert_titre(self,item):
        self.cur.execute("""INSERT OR IGNORE INTO F_titre (id_entreprise, id_date, id_description, id_source, id_location, titre) VALUES(?,?,?,?,?,?)""", item)
